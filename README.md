...
| 14 | [Longest Common Prefix](https://leetcode.com/problems/longest-common-prefix) | [Python](./Top-Interview-Questions/Longest_Common_Prefix.py) [Java](./Top-Interview-Questions/Longest_Common_Prefix.java) | O(S) | O(S) | Easy | |
